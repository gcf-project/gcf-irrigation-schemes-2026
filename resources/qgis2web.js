...
map.getView().fit([22.345358, -23.559061, 39.023483, -13.885748], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">GCF Irrigation Scheme Sites 2026</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (114 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'The map shows the distribution and progress of <br />GCF Irrigation Schemes in Zimbabwe as of the first of quarter 2026';
            }
...
var searchLayer = new SearchLayer({
    layer: lyr_NationalProvincialboundaries_1,
    colName: 'POPU_F',
    zoom: 10,
    collapsed: true,
    map: map,
